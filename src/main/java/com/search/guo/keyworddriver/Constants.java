...
public class Constants {
    //测试数据相关常量设定
    public static final String Path_ExcelFile = "configs/SearchByImage.xlsx";
    //测试数据 sheet 中的列号常量设定
    //第一列用 0 表示，测试用例序号列
    ...
    //测试用例集 sheet 的常量设定
    public  static  final String Sheet_TestSuite = "testcases";
    //测试用例 sheet 名称的常量设定
    public static final String Sheet_TestSteps = "steps";
